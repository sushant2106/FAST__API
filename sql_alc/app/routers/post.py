...
# from ..schemas import Product,UserOut,User,PostOut,PostCreate,Post
...
# def create_user(user:User,db:Session=Depends(get_db),get_current_user:int=Depends(oauth2.get_current_user)):
